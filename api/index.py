...
# ── 3-Level Placement System ─────────────────────────────────────────────────
# Levels: beginner (Boshlang'ich) | intermediate (O'rta) | advanced (Yuqori)
# 5 questions per level = 15 total, each worth 1 point
...
PLACEMENT_QUESTIONS = [
    ...
    {"id": "q3",  "question": "How do you greet someone in the morning?",
     ...
     "correct": "c", "level": "beginner", "points": 1},
    {"id": "q4",  "question": "Which animal says 'Moo'?",
     "options": [{"id":"a","text":"Cat 🐱"},{"id":"b","text":"Dog 🐶"},{"id":"c","text":"Cow 🐮"},{"id":"d","text":"Duck 🦆"}],
     "correct": "c", "level": "beginner", "points": 1},
    {"id": "q5",  "question": "How many days are in a week?",
     "options": [{"id":"a","text":"5"},{"id":"b","text":"6"},{"id":"c","text":"8"},{"id":"d","text":"7"}],
     "correct": "d", "level": "beginner", "points": 1},
    # ── O'RTA (Intermediate) ─────────────────────────────────────────────────
    {"id": "q6",  "question": "Choose the correct sentence:",
     "options": [{"id":"a","text":"I is a student."},{"id":"b","text":"I am a student."},{"id":"c","text":"I are a student."},{"id":"d","text":"I be a student."}],
     "correct": "b", "level": "intermediate", "points": 1},
    {"id": "q7",  "question": "She ___ to school every day.",
     "options": [{"id":"a","text":"go"},{"id":"b","text":"goes"},{"id":"c","text":"going"},{"id":"d","text":"gone"}],
     "correct": "b", "level": "intermediate", "points": 1},
    {"id": "q8",  "question": "What is the plural of 'child'?",
     "options": [{"id":"a","text":"childs"},{"id":"b","text":"childes"},{"id":"c","text":"children"},{"id":"d","text":"childrens"}],
     "correct": "c", "level": "intermediate", "points": 1},
    {"id": "q9",  "question": "I ___ already eaten lunch.",
     "options": [{"id":"a","text":"have"},{"id":"b","text":"has"},{"id":"c","text":"had"},{"id":"d","text":"having"}],
     "correct": "a", "level": "intermediate", "points": 1},
    {"id": "q10", "question": "She is ___ than her sister.",
     "options": [{"id":"a","text":"more tall"},{"id":"b","text":"tallest"},{"id":"c","text":"taller"},{"id":"d","text":"most tall"}],
     "correct": "c", "level": "intermediate", "points": 1},
    # ── YUQORI (Advanced) ────────────────────────────────────────────────────
    {"id": "q11", "question": "By the time she arrived, we ___ dinner.",
     "options": [{"id":"a","text":"finished"},{"id":"b","text":"have finished"},{"id":"c","text":"had finished"},{"id":"d","text":"finish"}],
     "correct": "c", "level": "advanced", "points": 1},
    {"id": "q12", "question": "The report ___ next week by the team.",
     "options": [{"id":"a","text":"will be submitted"},{"id":"b","text":"will submit"},{"id":"c","text":"is submitting"},{"id":"d","text":"submits"}],
     "correct": "a", "level": "advanced", "points": 1},
    {"id": "q13", "question": "Despite ___ hard all year, she failed the exam.",
     "options": [{"id":"a","text":"studying"},{"id":"b","text":"to study"},{"id":"c","text":"studied"},{"id":"d","text":"study"}],
     "correct": "a", "level": "advanced", "points": 1},
    {"id": "q14", "question": "The new regulations, ___ were introduced last month, caused controversy.",
     "options": [{"id":"a","text":"which"},{"id":"b","text":"that"},{"id":"c","text":"who"},{"id":"d","text":"what"}],
     "correct": "a", "level": "advanced", "points": 1},
    {"id": "q15", "question": "Had I known about the meeting, I ___ on time.",
     "options": [{"id":"a","text":"would have arrived"},{"id":"b","text":"would arrive"},{"id":"c","text":"arrived"},{"id":"d","text":"had arrived"}],
     "correct": "a", "level": "advanced", "points": 1},
]

_PLACEMENT_MAX = sum(q["points"] for q in PLACEMENT_QUESTIONS)  # 15

LEVEL_INFO = {
    "beginner":     {"name": "Boshlang'ich", "emoji": "🌱", "description": "Siz ingliz tilini endigina boshlayapsiz. Asosiy so'zlar va iboralarni o'rganasiz!", "difficulty": 1},
    "intermediate": {"name": "O'rta",        "emoji": "📘", "description": "Asosiy grammatikani bilasiz va oddiy jumlalar tuza olasiz. Yangi bosqichga tayyor!", "difficulty": 2},
    "advanced":     {"name": "Yuqori",       "emoji": "🏆", "description": "Ingliz tilini yaxshi bilasiz! Murakkab mavzularni o'rganish vaqti keldi.", "difficulty": 3},
}

def _calculate_placement_level(score: int, max_score: int) -> str:
    pct = (score / max_score) * 100 if max_score > 0 else 0
    # First 5 questions = beginner, next 5 = intermediate, last 5 = advanced
    # Score thresholds: 0-33% → beginner, 34-66% → intermediate, 67-100% → advanced
