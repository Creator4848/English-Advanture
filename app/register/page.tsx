...
import { Phone, Lock, BookOpen, AlertCircle, ArrowRight, User } from "lucide-react";
...
export default function RegisterPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="absolute top-[-20%] right-[-10%] w-[50%] h-[50%] bg-[#FFF3CC] rounded-full blur-[120px] opacity-60 pointer-events-none"></div>
            <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-[#FFB800] rounded-full blur-[150px] opacity-20 pointer-events-none"></div>
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
                ...
                <p className="mt-2 text-center text-sm font-bold text-gray-500">
                    Akkauntingiz bormi?{' '}
                    <Link href="/login" className="font-black text-[#FFB800] hover:underline">
                        Kirish
                    </Link>
                </p>
            </div>
